...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_proto_5fid_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_proto_5fid_2eproto = nullptr;
const uint32_t TableStruct_proto_5fid_2eproto::offsets[1] = {};
...
const ::_pbi::DescriptorTable descriptor_table_proto_5fid_2eproto = {
    false, false, 414, descriptor_table_protodef_proto_5fid_2eproto,
    "proto_id.proto",
    ...
    nullptr, file_level_enum_descriptors_proto_5fid_2eproto,
    file_level_service_descriptors_proto_5fid_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_5fid_2eproto_getter() {
  return &descriptor_table_proto_5fid_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_5fid_2eproto(&descriptor_table_proto_5fid_2eproto);
namespace Proto {
